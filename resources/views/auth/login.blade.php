      ...
      <div class="modal-body px-0 py-2 py-sm-0">
        ...
        <div class="row mx-0 align-items-center">
          ...
          <div class="col-md-6 px-4 pt-2 pb-4 px-sm-5 pb-sm-5 pt-md-5">
            <a class="btn btn-outline-info w-100 mb-3" id="sesionGoogle" href="{{ route('social.auth', 'google') }}"><i class="fi-google fs-lg me-1"></i>Inicia sesi&oacute;n con Google</a>
          ...
          @method('POST')
            ...
            <div class="mb-4">
              <div class="d-flex align-items-center justify-content-between mb-2">
                <label class="form-label mb-0" for="signin-password">Contraseña</label><!--<a class="fs-sm" href="#">¿Olvido la contraseña?</a>-->
              </div>
